...
- Use [NodeJS SDK](https://github.com/soketlabs/openai-realtime-api-beta) or [Python SDK](https://github.com/soketlabs/realtime-sdk-python) as per your application needs.
